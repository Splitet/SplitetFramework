...
import com.kloia.eventapis.api.emon.dto.TopicResponseDto;
...
@RestController
@RequestMapping(
        value = TopicsController.ENDPOINT
)
public class TopicsController {

    static final String ENDPOINT = "/topics";
    ...
    @GetMapping
    public ResponseEntity<Map<String, TopicResponseDto>> getTopics() {
        try {
