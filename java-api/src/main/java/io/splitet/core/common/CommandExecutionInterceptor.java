...
public class CommandExecutionInterceptor {
    ...
    @Before("this(io.splitet.core.api.CommandHandler) && @annotation(command)")
...
//        }
    ...
    @AfterReturning(value = "this(io.splitet.core.api.CommandHandler) && @annotation(command)", returning = "retVal")
